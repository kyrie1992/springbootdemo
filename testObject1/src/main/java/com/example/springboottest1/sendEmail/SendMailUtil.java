///**
// * Copyright &copy; 2016-2017 沈阳东深科技有限公司 All rights reserved.
// */
...
//    private static final String from = "";// SysConfigUtils.getValueByKey("3",
//                                                               // "email_address");
//
//    private static final String fromName = "";// SysConfigUtils.getValueByKey("3",
//                                                  // "project_name");
//
//    private static final String charSet = "utf-8";
//
//    private static final String username = "";// SysConfigUtils.getValueByKey("3",
//                                                                   // "email_address");
//
//    private static final String password = "";// SysConfigUtils.getValueByKey("3",
//                                                      // "email_password");
//
//    private static final String subject = "发票提醒";
//
...
//    /**
//     *
//     * getMailContent:取模版中的显示内容(即邮件正文)
//     *
//     * @author xuyq
//     * @param templatePath
//     *            模板名称
...
//     * @since JDK 1.6
//     */
////    public static String getMailContent(String templatePath, Map<String, Object> map) {
////        Template template = null;
////        Configuration freeMarkerConfig = null;
...
//     * @since JDK 1.6
//     */
////    public static boolean sendHtmlMail(String toMailAddr, String templatePath, Map<String, Object> map,
////            String attachFileName, byte[] fileByte) throws Exception {
////        // 判断是否需要身份认证
...
////        if (validate) {
////            // 如果需要身份认证，则创建一个密码验证器
////            authenticator = new MyAuthenticator(SendMailUtil.username, SendMailUtil.password);
////        }
////
...
////            Address from = new InternetAddress(SendMailUtil.from);// 创建邮件发送者地址
////            mailMessage.setFrom(from);// 设置邮件消息的发送者
////            Address to = new InternetAddress(toMailAddr);// 创建邮件的接收者地址
...
////            // 获取模板内容
////            template = freeMarkerConfig.getTemplate(getFileName(templatePath), new Locale("Zh_cn"), "UTF-8");
////            htmlText = FreeMarkerTemplateUtils.processTemplateIntoString(template, map);// 将模板内容对应成html
////
////            // 设置HTML内容
...
////            attachment.setFileName(MimeUtility.encodeText(attachFileName));
////            attachment.setContent(fileByte, "application/pdf");
